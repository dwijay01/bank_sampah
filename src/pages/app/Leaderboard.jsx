...
export default function Leaderboard() {
    ...
    return (
        <div className="mobile-page pb-24 bg-gray-50">
            {/* Header Section */}
            <div className="leaderboard-header bg-gradient-to-br from-green-600 to-green-800 text-white shadow-lg">
                ...
                <div className="leaderboard-my-rank bg-white/20 backdrop-blur-md rounded-2xl p-5 flex justify-between relative z-10">
                    <div>
            ...
            {/* List Section */}
            <div className="leaderboard-list-container px-5 -mt-10 relative z-20">
                    ...
                    {leaderboard.length === 0 ? (
                        ...
                        <div className="flex flex-col gap-2">
                            {leaderboard.map((user, index) => (
                                <div
                                    key={user.id}
                                    className={`leaderboard-item flex items-center gap-4 p-3 rounded-xl transition-all ${index < 3 ? 'top-3 bg-green-50' : ''}`}
                                >
                                    <div className="leaderboard-rank-icon flex items-center justify-center w-8">
                                        {getRankIcon(index)}
                                    </div>

                                    <div className="leaderboard-avatar h-12 w-12 rounded-full flex items-center justify-center text-2xl shadow-inner border border-green-300/50">
                                        {user.level_icon || '🌱'}
                                    </div>

                                    <div className="leaderboard-info flex-1">
                                    ...
                                    <div className="leaderboard-points flex items-center gap-1 bg-green-100 px-3 py-1.5 rounded-lg border border-green-200">
